// Access the data from HTML attributes (set by Mytitration1.html)
// These are created dynamically in Mytitration1.html from dataStorage
var data1 = document.getElementById('data1');
var var1 = data1 ? parseFloat(data1.getAttribute('data-php-variable')) : 0.1;//Normality of Burette(NaOH)
var data2 = document.getElementById('data2');
var var2 = data2 ? parseFloat(data2.getAttribute('data-php-variable')) : 10;//Volume of needed to added from burette
var data3 = document.getElementById('data3');
var var3 = data3 ? parseFloat(data3.getAttribute('data-php-variable')) : 0.1;//Normality of liquid in flask
var data4 = document.getElementById('data4');
var var4 = data4 ? parseFloat(data4.getAttribute('data-php-variable')) : 0.1;//Volume of liquid in flask
...
function preload() {
  ...
  flaskImg = loadImage('images/frontflask1.png', loaded);
...
function nextpressed() {
  // Navigate to results page instead of next sample for now
